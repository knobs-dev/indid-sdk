...
export declare namespace EnterpriseTransactionManager {
...
export interface UsersModuleInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [
      string,
      EnterpriseTransactionManager.CallStruct[],
      string,
      BigNumberish
    ]
  ): string;
...
export interface UsersModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UsersModuleInterface;
