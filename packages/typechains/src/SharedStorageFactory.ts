...
export interface SharedStorageFactoryInterface extends utils.Interface {
  functions: {
    "_entryPoint()": FunctionFragment;
    "accountImplementation()": FunctionFragment;
    "createAccount(address,bytes32,address,uint256)": FunctionFragment;
...
export interface SharedStorageFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SharedStorageFactoryInterface;
